...
class ListDraggableRouteState extends State<ListDraggableRoute> {
  ...
  void initState() {
    ...
    setState(() {
      items.add(
        Post(
            image: "assets/images/deals_layout/buildingMenu.jpg",
            id: 1,
            title: "Bank Account",
            desc: "Thank you"),
      );
      items.add(
        Post(
            image: "assets/images/deals_layout/cardMenu.jpg",
            id: 2,
            title: "Bank Account",
      ...
      items.add(
        Post(
            image: "assets/images/deals_layout/financeMenu.jpg",
            id: 3,
            title: "Bank Account",
      ...
      items.add(
        Post(
            image: "assets/images/deals_layout/findMenu.jpg",
            id: 4,
            title: "Bank Account",
      ...
      items.add(
        Post(
            image: "assets/images/deals_layout/giveMenu.jpg",
            id: 5,
            title: "Bank Account",
            desc: "Succes Account"),
      );
      items.add(
        Post(
            image: "assets/images/deals_layout/growthMenu.jpg",
            id: 6,
            title: "Bank Account",
      ...
      items.add(
        Post(
            image: "assets/images/deals_layout/locationMenu.jpg",
            id: 7,
            title: "Bank Account",
            desc: "Discount 10%"),
      );
      items.add(
        Post(
            image: "assets/images/deals_layout/moneyMenu.jpg",
            id: 8,
            title: "Bank Account",
            desc: "Discount 20%"),
      );
      items.add(
        Post(
            image: "assets/images/deals_layout/saveMenu.jpg",
            id: 9,
            title: "Bank Account",
            desc: "Discount 30%"),
      );
      items.add(
        Post(
            image: "assets/images/deals_layout/shareMenu.jpg",
            id: 10,
            title: "Bank Account",
            desc: "Discount 40%"),
      );
