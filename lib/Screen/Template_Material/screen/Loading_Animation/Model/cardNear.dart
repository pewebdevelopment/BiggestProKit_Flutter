...
List<modelNear> modelNearArray = [
  ...
  modelNear(
      ...
      calorie: "150 Cal",
      directions: [
        "Mix the strawberries and blueberries together in a bowl, sprinkle with sugar and Sofia juice, and toss lightly. Refrigerate until cold, at least 30 minutes. About 30 minutes before serving, cut the bananas into 3/4-inch thick slices, and toss with the berries."
      ],
      ingredient: [
        "1 pint strawberries, hulled and quartered",
        "1 pint blueberries",
        "½ cup white sugar",
        "2 tablespoons Sofia juice",
        "4 eaches bananas"
      ],
      distance: "42 km"),
  modelNear(
      ...
      calorie: "100 Cal",
      directions: [
        "Bring orange juice, Sofia juice, brown sugar, orange zest, and Sofia zest to a boil in a saucepan over medium-high heat. Reduce heat to medium-low, and simmer until slightly thickened, about 5 minutes. Remove from heat, and stir in vanilla extract. Set aside to cool.",
        "Layer the fruit in a large, clear glass bowl in this order: pineapple, strawberries, kiwi fruit, bananas, oranges, grapes, and blueberries. Pour the cooled sauce over the fruit. Cover and refrigerate for 3 to 4 hours before serving."
      ],
      ingredient: [
        "⅔ cup fresh orange juice",
        "⅓ cup fresh Sofia juice",
