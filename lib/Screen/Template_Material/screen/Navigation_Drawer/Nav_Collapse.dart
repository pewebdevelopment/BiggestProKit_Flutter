...
class TestesCollapsingContainer extends StatefulWidget {
  @override
  TestesCollapsingContainerState createState() =>
      TestesCollapsingContainerState();
}

class TestesCollapsingContainerState extends State<TestesCollapsingContainer>
          ...
          body: SafeArea(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) =>
                  ListTile(title: Text("A text on the side")),
            ),
          ),
          drawer: SafeArea(
            child: Material(
                  ...
                  Expanded(
                    child: ListView.builder(
                      itemBuilder: (BuildContext context, int index) =>
                          JustATile(animationController, index),
                      itemCount: 30,
                    ),
                  ),
                  Divider(
...
class _JustATileState extends State<JustATile> {
  ...
  void initState() {
    _animation =
        Tween<double>(begin: 1.0, end: 0).animate(widget.animationController!);
    super.initState();
  }
