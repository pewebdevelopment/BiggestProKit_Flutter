                        ...
                        decoration: new BoxDecoration(
                            image: new DecorationImage(
                                ...
                                image: new CachedNetworkImageProvider(
                                    'https://smartkit.wrteam.in/smartkit/images/logo.png')))),
                  ),
                ),
              ),
              Column(
                children: [
                  new ListTile(
                      ...
                      title: new Text("Music",
                          style: TextStyle(color: cryptocolor2)),
                      trailing: Icon(
                        Icons.navigate_next,
                        color: cryptocolor2,
                      ),
                  ...
                  new ListTile(
                      ...
                      title: new Text("Apps",
                          style: TextStyle(color: cryptocolor3)),
                      onTap: () {
                        Navigator.pop(context);
                      }),
                  new ListTile(
                      ...
                      title:
                          new Text("Docs", style: TextStyle(color: bookKing2)),
                      onTap: () {
                        Navigator.pop(context);
                      }),
                  new ListTile(
                      ...
                      title: new Text("Settings",
                          style: TextStyle(color: bookKing3)),
                      onTap: () {
                        Navigator.pop(context);
                      }),
                  new ListTile(
                      ...
                      title:
                          new Text("About", style: TextStyle(color: smartkey2)),
                      onTap: () {
                        Navigator.pop(context);
                      }),
                  new ListTile(
