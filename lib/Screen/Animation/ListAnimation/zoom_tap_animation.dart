...
class ZoomTapAnimationScreen extends StatefulWidget {
  ZoomTapAnimationScreen({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  _ZoomTapAnimationScreenState createState() => _ZoomTapAnimationScreenState();
}

class _ZoomTapAnimationScreenState extends State<ZoomTapAnimationScreen> {
  @override
