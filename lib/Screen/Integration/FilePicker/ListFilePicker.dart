            ...
            InkWell(
                onTap: () {
                  Navigator.of(context).push(PageRouteBuilder(
                      pageBuilder: (_, __, ___) => FilePickerLoading()));
                },
                child: card("File Picker Loading", Color(0xFF94D0CC))),
            InkWell(
                onTap: () {
                  Navigator.of(context).push(PageRouteBuilder(
                      pageBuilder: (_, __, ___) => FilePickerScreen()));
                },
                child: card("File Picker", Color(0xFF94D0CC))),
          ],
        ),
      ),
    );
