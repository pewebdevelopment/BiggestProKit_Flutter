...
class DatabaseHelper {
 ...
 /* Future<Map<String, dynamic>?>*/ queryRowById(id) async {
    ...
    List<Map> maps = await db!.query(table, where: '$columnId = ?', whereArgs: [id]);
    return maps.isNotEmpty ? maps.first /*as Future<Map<String, dynamic>?>*/ : null;
  }
  ...
  Future<int?> update(Item item) async {
    Database ?db = await (instance.database /*as Future<Database>*/);
    int? id = item.id;
    return await db?.update(table, item.toMap(), where: '$columnId = ?', whereArgs: [id]);
  }
