...
import 'package:crypto_template/Screen/FullApps/SunriseMart/B4_MyOrder_Screen/Step_Order/paymentMethod.dart';
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                Image.asset(
                                  "lib/Screen/FullApps/SunriseMart/Assets/house.jpg",
                                  height: 30.0,
                                ),
                                Padding(
                                  padding: const EdgeInsets.only(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                Image.asset(
                                  "lib/Screen/FullApps/SunriseMart/Assets/paypal.jpg",
                                  height: 30.0,
                                ),
                                Padding(
                                  padding: const EdgeInsets.only(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              children: <Widget>[
                                Image.asset(
                                  "lib/Screen/FullApps/SunriseMart/Assets/money.jpg",
                                  height: 19.0,
                                ),
                                Padding(
                                  padding: const EdgeInsets.only(
