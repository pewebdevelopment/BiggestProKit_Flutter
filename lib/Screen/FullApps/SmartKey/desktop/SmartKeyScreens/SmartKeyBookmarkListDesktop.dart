...
class SmartKeyBookmarkListDesktop extends StatefulWidget {
  ...
  @override
  _SmartKeyBookmarkListDesktopState createState() =>
      _SmartKeyBookmarkListDesktopState();
}

class _SmartKeyBookmarkListDesktopState
    extends State<SmartKeyBookmarkListDesktop> {
  List bookmarkList = [
    {
            ...
            children: <Widget>[
              Padding(
                ...
                child: Text(
                  "${index + 1}" + ".",
                  style:
                      TextStyle(fontWeight: FontWeight.bold, color: smartkey2),
                ),
              ),
              Flexible(
                child: Column(
                  ...
                  children: <Widget>[
                    Text(
                      ...
                      style: TextStyle(
                          fontWeight: FontWeight.bold, color: smartkey2),
                    ),
                    Padding(
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Text(bookmarkList[index]['answer'],
                              style: TextStyle(color: smartkey3)),
                        ],
                      ),
                    ),
                    Padding(
                      ...
                      child: Row(
                        children: <Widget>[
                          Text("Note : "),
                          Expanded(child: Text(bookmarkList[index]['note']))
                        ],
                      ),
                    ),
                    Align(
