...
import 'package:crypto_template/Screen/FullApps/SmartKey/desktop/SmartKeyScreens/SmartKeyLevelDesktop.dart';

class SmartKeySubCategoryDesktop extends StatefulWidget {
  SmartKeySubCategoryDesktop({Key? key}) : super(key: key);

  @override
  _SmartKeySubCategoryDesktopState createState() =>
      _SmartKeySubCategoryDesktopState();
}

class _SmartKeySubCategoryDesktopState
    extends State<SmartKeySubCategoryDesktop> {
  @override
