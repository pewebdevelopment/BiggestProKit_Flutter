...
import 'package:crypto_template/Screen/FullApps/SmartKey/SmartKeyScreens/SmartkeySingUp.dart';
...
class _SmartKeyLoginState extends State<SmartKeyLogin>
          ...
          CupertinoButton(
            onPressed: () {
              Navigator.push(
                context,
                PageRouteBuilder(
                    pageBuilder: (context, anim1, anim2) => SmartKeySingUp()),
              );
            },
