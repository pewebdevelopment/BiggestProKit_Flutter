...
import 'package:crypto_template/Screen/FullApps/SmartKey/tablet/SmartKeyScreens/SmartKeyInstructionTablet.dart';
import 'package:crypto_template/Screen/FullApps/SmartKey/tablet/SmartKeyScreens/SmartKeyLeaderboardTablet.dart';
import 'package:crypto_template/Screen/FullApps/SmartKey/tablet/SmartKeyScreens/SmartKeyUserProfileTablet.dart';
...
class _SmartKeyHomeTabletState extends State<SmartKeyHomeTablet> {
  int tabIndex = 0;
  List<Widget> body = [
    SmartKeyHomeDateTablet(),
    SmartKeyCategoryTablet(),
    SmartKeyLeaderboardTablet(),
    SmartKeyuserProfileTablet()
  ];
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      Navigator.push(
                          ...
                          PageRouteBuilder(
                              pageBuilder: (context, anim1, anim2) =>
                                  (SmartKeyNotificationListTablet())));
                    },
                  ),
