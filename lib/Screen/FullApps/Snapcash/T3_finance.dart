  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ListView(
          children: <Widget>[
            card("lib/Screen/FullApps/Coinbase/Assets/bils_finance.jpg",
                "Bills", "3 bills not been paid"),
            card("lib/Screen/FullApps/Coinbase/Assets/doctor_finance.jpg",
                "Doctor", "doctor not been paid"),
            card("lib/Screen/FullApps/Coinbase/Assets/hangout_finance.jpg",
                "Hangout", "food not been paid"),
            card("lib/Screen/FullApps/Coinbase/Assets/lifeStyle_finance.jpg",
                "LifeStyle", "2 t-shirt not been paid"),
            card("lib/Screen/FullApps/Coinbase/Assets/workout_finance.jpg",
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  //  Text(subTitle,style: TextStyle(color: Colors.black45,fontFamily: "Sofia"),),
                  SizedBox(
                    height: 60.0,
                  ),
                  Row(children: <Widget>[
