import 'package:crypto_template/Screen/FullApps/Coinbase/model_data/notification_model.dart';
...
class _T4_notificationState extends State<T4_notification> {
  ...
  void initState() {
    ...
    setState(() {
      items.add(
        Post(
            image: "lib/Screen/FullApps/Coinbase/Assets/buildingMenu.jpg",
            id: 1,
            title: "Bank Account",
            desc: "Thanks for downloaded ui kit"),
      );
      items.add(
        Post(
            image: "lib/Screen/FullApps/Coinbase/Assets/buildingMenu.jpg",
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            ...
            Image.asset(
              "lib/Screen/FullApps/Coinbase/Assets/notifications.jpg",
              height: 200.0,
            ),
