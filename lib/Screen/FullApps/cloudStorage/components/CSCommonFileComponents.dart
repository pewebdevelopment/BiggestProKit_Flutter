...
import 'package:crypto_template/Screen/FullApps/cloudStorage/components/CSCopyAndMoveComponents.dart';
import 'package:crypto_template/Screen/FullApps/cloudStorage/components/CSDisplayDataInGridViewComponents.dart';
...
class CSCommonFileComponentsState extends State<CSCommonFileComponents> {
  ...
  void selectAll() {
    ...
    getFileSharingList.forEach((element) => element.isFileSelect = isSelectAll);

    selectedItem = isSelectAll ? getFileSharingList.length : 0;
    setState(() {});
  }
  ...
  void ascendingOrderList() {
    getFileSharingList.sort((a, b) =>
        a.fileName!.toLowerCase().compareTo(b.fileName!.toLowerCase()));
  }

  void descendingOrderList() {
    getFileSharingList = getFileSharingList.reversed.toList();
  }
