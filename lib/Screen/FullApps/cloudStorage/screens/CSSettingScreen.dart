...
import 'package:crypto_template/Screen/FullApps/cloudStorage/screens/CSCameraUploadScreen.dart';
import 'package:crypto_template/Screen/FullApps/cloudStorage/screens/CSManageDevicesScreen.dart';
import 'package:crypto_template/Screen/FullApps/cloudStorage/screens/CSPasscodeScreen.dart';
...
import 'package:crypto_template/Screen/FullApps/cloudStorage/screens/CSWalkthroughScreen2.dart';
            ...
            child: Column(
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("FileSharing", style: boldTextStyle(size: 14))
                        .paddingOnly(top: 10, left: 16),
                    buildDivider(),
                    ...
                    buildListTileForSetting(
                      title: "Sync contacts",
                      subTitle:
                          "Then you can easily share with your contacts on FileSharing",
                      trailing: Switch(
                        value: syncContacts,
                        onChanged: (val) {
                          setState(() {
                ...
                buildListTileForSetting(
                  title: "Sign out of this FileSharing",
