...
import 'package:crypto_template/Screen/FullApps/cloudStorage/components/CSShareComponents.dart';
...
Widget buildDivider({bool isFull = false}) {
  return Divider(color: Colors.black.withOpacity(0.1))
      .paddingLeft(isFull ? 0 : 16);
}
        ...
        children: [
          Container(
            ...
            child: Column(
              ...
              children: [
                Text("Add to FileSharing",
                        style: TextStyle(
                            fontSize: 15, color: Colors.black.withOpacity(0.1)))
                    .paddingBottom(10),
                createBasicListTile(
    ...
    builder: (context) {
      return AlertDialog(
        ...
        content: dataModel.isFolder
            ...
            : Text(
                "Are you sure you want to delete this item from your FileSharing?"),
        actions: [
          TextButton(
            child: Text("Cancel",
                style: boldTextStyle(
                    size: 16, color: Colors.black.withOpacity(0.1))),
            onPressed: () {
  ...
  return showDialog(
    ...
    builder: (context) {
      return AlertDialog(
        ...
        content: Text(
            "Are you sure you want to delete these item from your FileSharing?"),
        actions: [
          TextButton(
            child: Text("Cancel",
                style: boldTextStyle(
        ...
        Container(
          child: Column(
            ...
            children: [
              ...
              createBasicListTile(
                  text: "Choose from FileSharing", icon: Icons.camera_alt),
              createBasicListTile(
