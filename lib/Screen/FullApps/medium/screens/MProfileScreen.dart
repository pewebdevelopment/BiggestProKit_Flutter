...
import 'package:crypto_template/Screen/FullApps/medium/screens/MEditProfileScreen.dart';
import 'package:crypto_template/Screen/FullApps/medium/screens/MFollowersListScreen.dart';
import 'package:crypto_template/Screen/FullApps/medium/screens/MFollowingScreen.dart';
                ...
                actions: [
                  PopupMenuButton(
                    ...
                    onSelected: (dynamic i) {
                      MEditProfileScreen(name: 'Smith JeffDev').launch(context);
                    },
                    itemBuilder: (context) => [
                      PopupMenuItem(
                        value: 1,
                ...
                delegate: _SliverContainerDelegate(Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Container(color: Colors.black26, width: 0.2, height: 40),
                      Container(
                        alignment: Alignment.center,
